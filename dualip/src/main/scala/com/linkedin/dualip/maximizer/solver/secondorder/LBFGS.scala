...
class LBFGS(alpha: Double,
   ...
   * @return
   */
  def penalizeNegativity(lambda: SparseVector[Double], constrainedResult: DualPrimalComputationResult,
                         iLog: mutable.Map[String, String]): DualPrimalComputationResult = {
